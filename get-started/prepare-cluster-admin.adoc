...
Nós controladores por cluster:: Cada cluster AFX deve ter pelo menos quatro nós. O número máximo de nós varia de acordo com a versão do ONTAP; por exemplo, a versão 9.19.1 permite até 32 nós por cluster AFX.
