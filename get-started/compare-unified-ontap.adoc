...
NetApp AFX é otimizado para cargas de trabalho NAS e de objetos de alto desempenho. Por isso, existem diferenças em relação aos sistemas de armazenamento AFF e FAS. Os seguintes recursos não estão disponíveis no NetApp AFX; a lista está organizada por recurso principal ou área funcional. Você também deve revisar as atualizações e alterações do AFX em link:../release-notes/whats-new-9171.html["O que há de novo"] com base na sua versão do ONTAP.
