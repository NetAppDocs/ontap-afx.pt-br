...
summary: Aprenda como instalar os switches para o sistema de storage AFX 2K e as prateleiras de storage. 
---
= Instale os switches para o seu sistema de storage AFX 2K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Após concluir os preparativos para a instalação do sistema de storage AFX 2K, você deve instalar os switches no gabinete ou rack.
...
NOTE: Se o fluxo de ar dos seus switches estiver configurado para entrada de ar pelo lado das portas (ventiladores e fontes de alimentação na cor bordô), as portas de rede dos switches devem ser instaladas voltadas para a frente do gabinete e os ventiladores de exaustão devem estar voltados para a parte traseira do gabinete. Com essa configuração, você deve garantir que utilize cabos com comprimento suficiente para conectar as portas de rede na frente do gabinete às portas de storage na parte traseira do gabinete. + Para obter informações mais detalhadas sobre esses switches, visite o site da Cisco: link:https://www.cisco.com/c/en/us/td/docs/switches/datacenter/nexus9000/hw/9800/9808/nx-os/cisco-nexus-9808-nx-os-mode-switch-hardware-installation-guide/m-8000-modular-overview-ph2.html["Guia de Instalação de Hardware do Switch Cisco Nexus 9808 Mode"^], link:https://www.cisco.com/c/en/us/td/docs/dcn/hw/nx-os/nexus9000/9332d-gx2b/cisco-nexus-9332d-gx2b-nx-os-mode-switch-hardware-installation-guide.html["Cisco Nexus 9332D-GX2B Guia de Instalação de Hardware do Switch"^] e link:https://www.cisco.com/c/en/us/td/docs/dcn/hw/nx-os/nexus9000/9364d-gx2a/cisco-nexus-9364d-gx2a-nx-os-mode-switch-hardware-installation-guide.html["Guia de Instalação de Hardware do Switch de Modo Cisco Nexus 9364D-GX2A"^].
...
== Instalação do switch Cisco Nexus 9808

Se você estiver instalando o switch Cisco Nexus 9808, consulte o link:https://www.cisco.com/c/en/us/td/docs/switches/datacenter/nexus9000/hw/9800/9808/nx-os/cisco-nexus-9808-nx-os-mode-switch-hardware-installation-guide/m-8000-install-chassis.html["Guia de Instalação de Hardware do Switch Cisco Nexus 9808 Mode"^] para obter instruções detalhadas sobre como instalar os switches no gabinete ou rack.



== Instalação do switch Cisco Nexus 9332D-GX2B e 9364D-GX2A

Se você estiver instalando Cisco Nexus 9332D-GX2B ou 9364D, execute as seguintes etapas para instalar os switches no gabinete ou rack.
...
.. Passe os conectores fêmea de ambos os cabos de ligação pela parte traseira do painel através do conjunto da escova.
+
...
+
Instale os dois switches em locais do gabinete que proporcionem acesso eficiente aos controladores e prateleiras, como nas fileiras do meio.
...
.O que vem a seguir?
Após instalar os switches no gabinete ou rack, você link:deploy-hardware.html["Instale o sistema de storage AFX 2K e as prateleiras no armário ou rack"].
