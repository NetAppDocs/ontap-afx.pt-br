...
---
= Requisitos de rede para o seu sistema de storage AFX 2K
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
[role="lead"]
Registre as informações necessárias para cada rede à qual você se conecta ao seu sistema de storage AFX 2K.



== Reúna informações de rede

Antes de iniciar a instalação do seu sistema de storage AFX 2K, reúna as informações de rede necessárias
...
Para instalação e manutenção dos switches Cisco Nexus 9808, Cisco Nexus 9332D-GX2 e 9364D-GX2A, certifique-se de revisar os requisitos de cabeamento e rede.
...
.O que vem a seguir?
Após analisar os requisitos de rede, você link:cable-hardware.html["Conecte os controladores e as prateleiras de armazenamento para o seu sistema de storage AFX 2K"].
