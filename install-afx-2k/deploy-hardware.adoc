...
summary: Aprenda como instalar os kits de trilhos para o sistema de storage AFX 2K e as prateleiras de armazenamento, e como fixar o hardware AFX no gabinete ou rack de telecom. 
---
= Instale seu sistema de storage AFX 2K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Após instalar os switches, você deve instalar o hardware do seu sistema de storage AFX 2K. Primeiro, instale os kits de trilhos. Em seguida, instale e fixe seu sistema de storage em um gabinete ou rack telco.
...
. Se o seu sistema de storage AFX 2K veio com um dispositivo de gerenciamento de cabos, fixe-o na parte traseira do sistema de storage.
+
...
.O que vem a seguir?
Após instalar o hardware do seu sistema AFX, revise o link:afx-cable-overview.html["Configurações de cabeamento suportadas para o seu sistema de storage AFX 2K"].
