...
* Para implantações do AFX 1K com AI Data Engine (AIDE), acesse o link:https://docs.netapp.com/us-en/ai-data-engine/install-setup/aide-hardware-requirements.html["Instalar nós de computação de dados AIDE"].
