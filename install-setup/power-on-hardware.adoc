...
.O que vem a seguir?
Após ligar o seu sistema de storage AFX 1K, conclua a configuração de acordo com a opção de implementação:

* Para implantações dedicadas do sistema de storage AFX 1K, acesse link:../install-setup/cluster-setup.html["Configurar um cluster AFX"].
* Para implantações do AFX 1K com AI Data Engine (AIDE), instale servidores de terceiros do AIDE ou nós de computação de dados fornecidos pela NetApp:
