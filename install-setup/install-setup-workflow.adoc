...
NOTE: Se você estiver implementando o AFX 1K com o AI Data Engine (AIDE), instale os nós de computação de dados do AIDE após ligar o sistema AFX. Consulte link:https://docs.netapp.com/us-en/ai-data-engine/install-setup/aide-hardware-requirements.html["Instalar nós de computação de dados AIDE"] para mais informações.
