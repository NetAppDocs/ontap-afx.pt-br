...
image::../media/drw_afx_management_connection_ieops-2815.svg[Conecte-se à sua rede de gerenciamento]
...
+
image::../media/drw_afx_network_cabling_a_ieops-2813.svg[Cabo para rede Ethernet]
...
+
image::../media/drw_afx_network_cabling_b_ieops-2814.svg[Cabo para rede Ethernet]
...
== Etapa 3: conecte os cabos do cluster, da interconexão HA e das conexões de armazenamento ao switch de rede A

Utilize o cabo breakout 4x100GbE para conectar as portas de cluster, interconexão HA e armazenamento dos controladores ao switch de rede A. Utilize o cabo de interconexão de cluster e HA para conectar as portas e1a e e7a ao switch A. As portas e1a são utilizadas para as conexões de HA e as portas e7a são utilizadas para as conexões de cluster. Para as conexões de armazenamento, conecte as portas e10a e e11a ao switch A.

Certifique-se de que possui os cabos e conectores corretos para seus switches. Veja  https://hwu.netapp.com["Hardware Universe"^] para mais informações.

.Passos
. Conecte as seguintes portas do controlador a qualquer porta que não seja ISL no switch de rede A.
+
** Controlador
+
*** e1a (HA)
...
+
image::../media/drw_afx_ha_cluster_storage_a_ieops-2779.svg[Cluster de controladores com cabos,800px,and storage to switch A]
...
== Etapa 4: conecte os cabos do cluster, da interconexão HA e das conexões de armazenamento ao Switch B

Utilize o cabo breakout 4x100GbE para conectar as portas de cluster, interconexão HA e armazenamento dos controladores ao switch de rede B. Use o cabo de interconexão de cluster e HA para conectar as portas e1b e e7b ao switch B. As portas e1b são utilizadas para as conexões de HA e as portas e7b são utilizadas para as conexões de cluster. Para as conexões de armazenamento, conecte as portas e10b e e11b ao switch B.

Certifique-se de que possui os cabos e conectores corretos para seus switches. Veja  https://hwu.netapp.com["Hardware Universe"^] para mais informações.

. Conecte as seguintes portas do controlador a qualquer porta que não seja ISL no switch de rede B.
+
** Controlador
+
*** e1b (HA)
...
+
image::../media/drw_afx_ha_cluster_storage_b_ieops-2780.svg[Cluster de controladores com cabos,800px,and storage to switch B]
