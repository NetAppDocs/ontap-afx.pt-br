...
+
image::../media/drw_afx_ha_cluster_storage_a_ieops-2779.svg[Cluster de controladores com cabos,HA,and storage to switch A]
...
+
image::../media/drw_afx_ha_cluster_storage_b_ieops-2780.svg[Cluster de controladores com cabos,HA,and storage to switch B]
